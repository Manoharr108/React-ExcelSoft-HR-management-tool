...
const CardItem = (props) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      props.handleAlert(
        `Employee ID : ${props.value} deleted successfully!`,
        "success"
      );
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      const updatedEmployees = props.employees.map((emp) =>
        emp.empid === empid ? { ...emp, ...updatedEditForm } : emp
      );

      props.setEmployees(updatedEmployees);
      props.SetLoading(false);
      props.handleAlert(
        `Employee ID : ${empid} details updated successfully!`,
        "success"
      );
    } catch (error) {
      ...
      >
        ...
        <div className="card-body">
          <h5
            ...
            style={{ marginBottom: "0", color: "#0f6cbd" }}
          >
            {props.name}
          </h5>
        ...
        >
          {isAdmin && (
            ...
            >
              ...
              >
                <img src={Edit} alt="edit icon" style={{ color: "black" }} />{" "}
                <span>Edit</span>
              </div>
            </button>
          )}
          {isAdmin && (
            <button className="btn btn-danger" onClick={handleDelete}>
              ...
              >
                <img src={Delete} alt="del icon" style={{ color: "black" }} />{" "}
                <span>Delete</span>
              </div>
            </button>
          )}
            ...
            <div className="modal-header border-bottom-0">
              <div className="d-flex flex-column">
                <h5 className="modal-title" id="employeeModalLabel">
                  {empdetails.name} - Achiever of "{props.currtab}" in Quarter{" "}
                  {props.activeQuarter}
                </h5>
              </div>
              <button
            ...
            <div className="modal-body px-4 pb-4">
              <div className="row align-items-center">
                <div className="col-md-6" style={{ position: "relative" }}>
                  ...
                  >
                    {" "}
                    <h5 className="mb-1">{empdetails.name}</h5>
            ...
            <div className="modal-body">
              <form id="addEmp">
                ...
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control" id="editrole" />
                </div>
                <div className="mb-3">
